...
<script type="text/javascript">
		...
		$.ajax({
			...
			success : function(data) {
					...
					for(var i = 0; i < length; i++){
						...
						var flag3 = true;
						var flag4 = true;
						var searchData = eval(data)[i];
						for(var j=0;j<i;j++){
							var temp = eval(data)[j];
							if(temp.cpu == searchData.cpu){ flag1 = false;}
							if(temp.hardDisk == searchData.hardDisk){ flag2 = false;}
							if(temp.memory == searchData.memory){ flag3 = false;}
							if(temp.size == searchData.size){ flag4 = false;}
						}
						if(flag1){
						var cpuButton = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:;' id='cpuButton' class='label label-default' onclick='selectCpu(\""+ searchData.cpu +"\")'>&nbsp;&nbsp;"+searchData.cpu+"&nbsp;&nbsp;</a>";
						document.getElementById("cpuDiv").innerHTML += cpuButton;
						}
						if(flag2){
						var diskButton = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:;' id='diskButton' type='button' class='label label-default' onclick='selectDisk("+ searchData.hardDisk +")'>&nbsp;&nbsp;"+searchData.hardDisk+"G&nbsp;&nbsp;</a>";
						document.getElementById("hardDiskDiv").innerHTML += diskButton;
						}
						if(flag3){
						var memoryButton = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:;' id='memoryButton' type='button' class='label label-default' onclick='selectMemory("+ searchData.memory +")'>&nbsp;&nbsp;"+searchData.memory+"G&nbsp;&nbsp;</a>";
						document.getElementById("memoryDiv").innerHTML += memoryButton;
						}
						if(flag4){
						var sizeButton = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:;' id='sizeButton' type='button' class='label label-default' onclick='selectSize("+ searchData.size +")'>&nbsp;&nbsp;"+searchData.size+"英寸&nbsp;&nbsp;</a>";
						document.getElementById("sizeDiv").innerHTML += sizeButton;
						}
						var liData = "<li><a href='single.jsp?computerName="+searchData.name+"'><img  style='width:230px;height:230px' class='img-rounded' src='" + searchData.imagePath +"'/><h5>" + searchData.name +"</h5></a></li>"
						document.getElementById("ul").innerHTML += liData;
						//alert(searchData.imagePath);
					}
	...
	function removeA(id) {
		...
		if ($("#nowCpu").length <= 0) {
			...
			nowCpu = document.getElementById("nowCpu").innerText;
		}
		if ($("#nowDisk").length <= 0) {
			nowDisk = -1
		} else {
			nowDisk = document.getElementById("nowDisk").innerText;
		}
		if ($("#nowMemory").length <= 0) {
			nowMemory = -1
		} else {
			nowMemory = document.getElementById("nowMemory").innerText;
		}
		if ($("#nowSize").length <= 0) {
			nowSize = -1
		} else {
			nowSize = document.getElementById("nowSize").innerText;
		}
		if ($("#nowLow").length <= 0) {
			nowLow = -1
		} else {
			nowLow = document.getElementById("nowLow").innerText;
		}
		if ($("#nowHigh").length <= 0) {
			nowHigh = -1
		} else {
			nowHigh = document.getElementById("nowHigh").innerText;
		}
		//alert("Disk" + nowCpu);
		$
				.ajax({
					type : "POST",
					url : "middle/selectComputer.jsp",
					data : {
						cpu : nowCpu,
						hardDisk : nowDisk,
						memory : nowMemory,
					...
					success : function(data) {
						...
						for (var i = 0; i < length; i++) {
							var searchData = eval(data)[i];
							var liData = "<li><a href='single.jsp?computerName="
									+ searchData.name
									+ "'><img  style='width:230px;height:230px' class='img-rounded' src='" + searchData.imagePath +"'/><h5>"
									+ searchData.name + "</h5></a></li>"
							html.innerHTML += liData;
							//alert(searchData.imagePath);
						}
					},
					error : function() {
		...
		var a = document.getElementById("now").getElementsByTagName("a").length;
		if (a > 0) {
			;
		} else {
			document.getElementById("now").innerHTML = "<label>已选择：</label>";
			$("#now").hide();
		}
	}
	...
	function selectCpu(cpu) {
		...
		$("#cpuDiv").hide();
		$("#now").show();
		document.getElementById("now").innerHTML += "<label id='showCpu'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CPU:\
				<a id='nowCpu' href='javascript:;'  class='label label-default' onclick='removeA(1)'>"
				+ cpu + "</a></label>";
		if ($("#nowDisk").length <= 0) {
			nowDisk = -1
		} else {
	...
	function selectDisk(disk) {
		$("#hardDiskDiv").hide();
		$("#now").show();
		document.getElementById("now").innerHTML += "<label id='showDisk'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\
				&nbsp;&nbsp;&nbsp;硬盘:\
				<a id='nowDisk' href='javascript:;'  class='label label-default' onclick='removeA(2)'>"
				+ disk + "</a></label>";
		if ($("#nowCpu").length <= 0) {
			nowCpu = -1
		} else {
	...
	function selectMemory(memory) {
		$("#memoryDiv").hide();
		$("#now").show();
		document.getElementById("now").innerHTML += "<label id='showMemory'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;内存：\
				<a id='nowMemory' href='javascript:;'  class='label label-default' onclick='removeA(3)'>"
				+ memory + "</a></label>";
		if ($("#nowCpu").length <= 0) {
			nowCpu = -1;
		} else {
	...
	function selectSize(size) {
		$("#sizeDiv").hide();
		$("#now").show();
		document.getElementById("now").innerHTML += "<label id='showSize'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;尺寸：\
				<a id='nowSize' href='javascript:;'  class='label label-default' onclick='removeA(4)'>"
				+ size + "</a></label>";
		if ($("#nowCpu").length <= 0) {
			nowCpu = -1
		} else {
	...
	function selectPrice(low, high) {
		$("#priceDiv").hide();
		$("#now").show();
		document.getElementById("now").innerHTML += "<label id='showPrice'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价格:\
				<a id='nowPrice' href='javascript:;'  class='label label-default' onclick='removeA(5)'><label id='nowLow'>"
				+ low
				+ "</label>-<label id='nowHigh'>"
				+ high
				+ "</label></a></label>";
		if ($("#nowCpu").length <= 0) {
			nowCpu = -1;
...
<body onload="load()">
	...
	<div class="search_main clearfix search_tab">
		...
		<div id="priceDiv">
			<label>价格区间:</label>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
				href='javascript:;' id='cpuButton' class='label label-default'
				onclick="selectPrice(-1,1999)"> &nbsp;&nbsp;1999</lable>以下&nbsp;&nbsp;
			</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
				href='javascript:;' id='cpuButton' class='label label-default'
				onclick="selectPrice(2000,2999)">
				2000&nbsp;&nbsp;-&nbsp;&nbsp;2999</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
				href='javascript:;' id='cpuButton' class='label label-default'
				onclick="selectPrice(3000,3999)">
				3000&nbsp;&nbsp;-&nbsp;&nbsp;3999</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
				href='javascript:;' id='cpuButton' class='label label-default'
				onclick="selectPrice(4000,4999)">
				4000&nbsp;&nbsp;-&nbsp;&nbsp;4999</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
				href='javascript:;' id='cpuButton' class='label label-default'
				onclick="selectPrice(5000,6999)">
				5000&nbsp;&nbsp;-&nbsp;&nbsp;6999</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
				href='javascript:;' id='cpuButton' class='label label-default'
				onclick="selectPrice(7000,9999)">
				7000&nbsp;&nbsp;-&nbsp;&nbsp;9999</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
				href='javascript:;' id='cpuButton' class='label label-default'
				onclick="selectPrice(10000,-1)"> &nbsp;&nbsp;10000以上&nbsp;&nbsp;</a>
		</div>
		<hr />
		<div class="container">
			<div id="search_result" class="row">
				<ul id="ul" class="nav navbar-nav menu__list">
