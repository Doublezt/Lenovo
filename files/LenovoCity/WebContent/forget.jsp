	...
	$(document).ready(
			function() {
				...
				$("#phoneButton").click(function() {
					if ($("#key").val() == $("#check").val()) {
						$.ajax({
							type : "post",
							url : "middle/getPassword.jsp",
							data : {
								username : $("#username").val()
							},
							success : function(data) {
...
<body>
	...
	<!-- 搜索页面信息 -->
	<div class="search_main clearfix search_tab" style="width:600px;margin-left:auto;margin-right:auto;">
		<form id="forget" role="form" class="form-horizontal" method="POST">
			<div class="form-group">
				<label for="username" class="col-sm-2 ">账号:</label> <input
					placeholder="请输入账号" type="text" id="username">
			</div>

			<div class="form-group">
				<label for="key" class="col-sm-2">手机验证码:</label> <input type="text"
					placeholder="请输入验证码" id="key" name="key">
			</div>

			<div class="form-group" style="display: none">
				<label for="check" class="col-sm-2">检测验证码:</label> <input
					type="text" id="check" name="check">
			</div>
			
			
			<div class="form-group">
				<a id="sendPhone" class="navbar-brand">发送验证码</a>
				<a id="phoneButton" class="navbar-brand">提交</a>
			</div>
